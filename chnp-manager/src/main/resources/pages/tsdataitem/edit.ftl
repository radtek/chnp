<div class="modal fade" id="tsdataitem_edit_modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="/tsdataitem/update">
                    <input name="id" type="text" value="${tsDataItem.id}" hidden>
            ...
            <div class="modal-footer">
                <button id="tsdataitem_edit_btn_update" type="button" class="btn btn-primary">保存</button>
    ...
    <script>
        $(function () {
            ...
            $('#tsdataitem_edit_modal').on('shown.bs.modal', function() {

                $("#tsdataitem_edit_btn_update").on("click", function(e) {
                    e.preventDefault();

                    var form = $("#tsdataitem_edit_modal form");
                    $.ajax({
                        type: "POST",
                        ...
                        success: function(json) {
                            if (1 === json.returnCode) {
                                $("#tsdataitem_edit_modal").modal("hide");
            ...
            $('#tsdataitem_edit_modal').on('hidden.bs.modal', function() {
                $(this).remove();
                tsdataitemedit = null;
            });
        })
