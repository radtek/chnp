<div class="modal fade" id="tskey_edit_modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="/tskey/update">
                        <input name="id" type="text" value="${tsKey.id}" hidden>
            ...
            <div class="modal-footer">
                <button id="tskey_edit_btn_update" type="button" class="btn btn-primary">保存</button>
    ...
    <script>
        $(function () {
            ...
            $('#tskey_edit_modal').on('shown.bs.modal', function() {

                $("#tskey_edit_btn_update").on("click", function(e) {
                    e.preventDefault();

                    var form = $("#tskey_edit_modal form");
                    $.ajax({
                        type: "POST",
            ...
            $('#tskey_edit_modal').on('hidden.bs.modal', function() {
                $(this).remove();
                delete tsKeyEdit;
            });
        })
