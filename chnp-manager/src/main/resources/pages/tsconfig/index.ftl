    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            tsconfig.searching = function() {
                ...
                tsconfig.dataTablesUtil.getDataTable().ajax.reload();
            };
                    ...
                    operate: {
                        ...
                        "render": function (data, type, full, meta) {
                            return '&nbsp;<button class="op-btn-view" type="button" data-url="/tsconfig/view?id=' + data + '" onclick="modal($(this))"><i class="fa fa-eye"></i>查看</button>' +
                                    '&nbsp;<button class="op-btn-edit" type="button" data-url="/tsconfig/edit?id=' + data + '" onclick="modal($(this))"><i class="fa fa-edit"></i>编辑</button>' +
                                    '&nbsp;<button class="op-btn-del" type="button" data-url="/tsconfig/del?ids=' + data + '" onclick=""><i class="fa fa-trash"></i>删除</button>';
                        }
                    },
                    dataTable: {
                        order: [
