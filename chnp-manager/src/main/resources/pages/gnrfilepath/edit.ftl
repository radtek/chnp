<div class="modal fade" id="gnrfilepath_edit_modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="/gnrfilepath/update">
                    <input name="id" type="text" value="${gnrFilepath.id}" hidden>
            ...
            <div class="modal-footer">
                <button id="gnrfilepath_edit_btn_update" type="button" class="btn btn-primary">保存</button>
    ...
    <script>
        $(function () {
            ...
            $('#gnrfilepath_edit_modal').on('shown.bs.modal', function() {

                $("#gnrfilepath_edit_btn_update").on("click", function(e) {
                    e.preventDefault();

                    var form = $("#gnrfilepath_edit_modal form");
                    $.ajax({
                        type: "POST",
                        ...
                        success: function(json) {
                            if (1 === json.returnCode) {
                                $("#gnrfilepath_edit_modal").modal("hide");
            ...
            $('#gnrfilepath_edit_modal').on('hidden.bs.modal', function() {
                $(this).remove();
                delete gnrFilepathEdit;
            });
        })
    </script>
</div>