    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="/tsmodule/save">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <#list moduleTypes as type>
                                <option value="${type.name}">${type.chinese}</option>
                            </#list>
                            </select>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button id="tsmodule_new_btn_save" type="button" class="btn btn-primary">保存</button>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#tsmodule_new_modal').on('shown.bs.modal', function() {
                ...
                $("#tsmodule_new_btn_save").on("click", function(e) {
                    e.preventDefault();

                    var form = $("#tsmodule_new_modal form");
                    $.ajax({
                        type: "POST",
